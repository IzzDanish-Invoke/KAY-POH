...
import { matchingQuestions, packages as initialPackages, tourGuides as initialTourGuides } from "@/data/data";
...
const DEFAULT_PLAN_ID =
  initialPackages.find((pkg) => pkg.tag === "Best first visit")?.id ?? initialPackages[0].id;
